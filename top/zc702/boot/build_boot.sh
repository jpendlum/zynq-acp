...
cp "../../../../openembedded-core/build_zc702/tmp-eglibc/deploy/images/uImage-zc702.bin" "uImage.bin"
...
cp "../../../../openembedded-core/build_zc702/tmp-eglibc/deploy/images/uImage-zynq-zc702-user-peripheral.dtb" "devicetree.dtb"
