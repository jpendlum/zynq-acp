...
cp "../../../../openembedded-core/build_zc706/tmp-eglibc/deploy/images/uImage" "uImage.bin"
...
cp "../../../../openembedded-core/build_zc706/tmp-eglibc/deploy/images/uImage-zc706-user-peripheral-zynq7.dtb" "devicetree.dtb"
